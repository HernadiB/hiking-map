...
const translations = {
  en: {
    ...
    homeTotalDuration: 'Total trail time',
    homeTotalAscent: 'Total ascent',
    homeHighestPoint: 'Highest point reached',
    homeCollectionSnapshot: 'Collection snapshot',
    homeCollectionSnapshotShow: 'Show overview',
    homeCollectionSnapshotHide: 'Minimize',
    ...
    homeFilterTitle: 'Filter hikes',
    homeFilterSearchLabel: 'Search',
    homeFilterSearchPlaceholder: 'Search by title...',
    homeFilterDifficultyLabel: 'Difficulty',
    homeFilterRouteTypeLabel: 'Route type',
    homeFilterResults: '{{count}} of {{total}} hike{{suffix}} shown',
    homeFilterEmpty: 'No hikes match the current filters.',
    homeFilterShow: 'Show filters',
    homeFilterHide: 'Hide filters',
    ...
    detailImportedOnly: 'Imported {{imported}}',
    detailOverview:
  ...
  hu: {
    ...
    homeTotalDuration: 'Összes túraidő',
    homeTotalAscent: 'Összes emelkedés',
    homeHighestPoint: 'Legmagasabb elért pont',
    homeCollectionSnapshot: 'Gyűjtemény összképe',
    homeCollectionSnapshotShow: 'Összkép megnyitása',
    homeCollectionSnapshotHide: 'Kis méret',
    ...
    homeFilterTitle: 'Túrák szűrése',
    homeFilterSearchLabel: 'Keresés',
    homeFilterSearchPlaceholder: 'Keresés név alapján...',
    homeFilterDifficultyLabel: 'Nehézség',
    homeFilterRouteTypeLabel: 'Útvonaltípus',
    homeFilterResults: '{{count}} / {{total}} túra megjelenítve',
    homeFilterEmpty: 'Nincs a szűrésnek megfelelő túra.',
    homeFilterShow: 'Szűrők megnyitása',
    homeFilterHide: 'Szűrők elrejtése',
    ...
    detailImportedOnly: 'Importálva {{imported}}',
    detailOverview:
